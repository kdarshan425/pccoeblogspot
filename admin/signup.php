...
<head>
    ...
    <title>SIGNUP | PCCOE BLOGSPOT</title>
    ...
    <div class="admin">        
        <div class="inneradmin">
            <div class="head" style="padding-bottom:50px;">
                <h3 style="font-family: 'Orbitron', sans-serif;color: #8888A0;">Hi Blogger, Setup your account!</h3>
            </div>
            <form action="<?php $_SERVER["REQUEST_URI"]?>" method="post">
                ...
                <div style="padding-top:30px;"><button style="background:#63C8FF" type="submit" name="submit" class="forum-btn btn-f">Submit</button></div>                
            </form>
        </div>
    </div>
...
if (isset($_POST['submit'])) {
    ...
    elseif ($numRows1>0) {
        ...
        if($pass==$cpass){
            ...
            if($result){  
                ...
                $to = "$user_email";
                $subject = "Email Verification By PCCOE BLOGSPOT";
                $msg='
                ...
                <head>    
                    <link href="https://fonts.googleapis.com/css2?family=Abril+Fatface&family=Archivo:wght@300&family=Orbitron:wght@500&display=swap" rel="stylesheet">
                    <title>Welcome To PCCOE BLOGSPOT!</title>
                    <style>
                    .btn1 {
                    position: relative; 
                    border:none;       
                ...
                <body>
                    ...
                    <center>
                        <div style=" max-width:600px;padding:30px;" >            
                            <h3 style="font-size:30px;    font-family: "Orbitron", sans-serif;">Welcome To PCCOE BLOGSPOT !</h3>
                            <div style="padding-top: 10px;">
                                <h4 style="text-align:start;">
                                Hi '.$user_name.',
                                We are glad to have you as a part of PCCOE BLOGSPOT! 
                                </h4>
                                <h4 style="text-align:start;">
                                Please complete your signup process by verifying your E-mail address below,
                                </h4>
                                <div style="padding:40px;">
                                <a style="color:white" href="https://pccoeblogspot.herokuapp.com/admin/_verification.php?token='.$token.'" class="btn1">Verify Email</a>
                                </div> 
                                <h4>Or click below<br> 
                                https://pccoeblogspot.herokuapp.com/admin/_verification.php?token='.$token.'</h4>  
                ...
                if(!$mail->Send()){
                    ...
                    echo $mail->ErrorInfo;
                    echo "Email sending failed please <a href='https://pccoeblogspot.herokuapp.com/contactus.php'>contact here</a>";
                }else{
                    $showError = "Email sent successfully";   
                    echo "Email successfully sent to $to Please Verify email address";             
                    echo "<script>window.location.href='https://pccoeblogspot.herokuapp.com/admin/_varification.emailsent.php?email=$to';</script>";
                    exit;
                }
                // session_start();
                ...
                // $_SESSION['sno'] = $dno;
                // header("Location: http://localhost/blog/index.php?signupsuccess=true");
                // exit();                      
            }
        }
        else{
    ...
    echo "<script>window.location.href='https://pccoeblogspot.herokuapp.com/admin/signup.php?signupsuccess=false&error=$showError';</script>";
    exit;
}
}
?>
