...
<head>
    ...
    <title>CREATE BLOG | PCCOE BLOGSPOT</title>
    ...
    if (isset($_POST['submit'])) {
        ...
        if($method=='POST'){
            ...
            if($_FILES['image1']['size'] == 0){
                ...
                $sql1 =  "INSERT INTO `blogs` (`id`, `blog_owner`, `Heading`, `name`, `content`, `timestamp`) VALUES (NULL, '$blog_owner' , '$heading', '$name', '$blog', current_timestamp());";
                ...
                if($result){           
                    ...
                    <div class="alert">
                                ';?>
                                <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
                                <strong>Some error occured!</strong> Field not uploaded !
                                <?php echo'
                            </div>
                    ' ;
                }
                ...
                if(in_array($file_ext_check1, $valid_file_ext)){
                    ...
                    $sql1 =  "INSERT INTO `blogs` (`id`, `blog_owner`, `Heading`, `name`, `image`, `content`, `timestamp`) VALUES (NULL, '$blog_owner', '$heading', '$name', '$ch_image1', '$blog', current_timestamp());";
                    $result = mysqli_query($conn, $sql1);
    ...
    <div>
       <div class="container">
           <div style="padding:50px;">
               <center>
               <h1 class="bar" style="font-family: 'Orbitron', sans-serif;">CREATE BLOG</h1>
               </center>
           </div>
       </div>
        <div class="container">   
            ...
            <form method="post" action="<?php $_SERVER["REQUEST_URI"]?>" enctype="multipart/form-data">                
                ...
                <div class="mb-3" style="margin-top:0px;margin-bottom:40px;">
                    ...
                    <input class="form-control" name="image1" type="file" id="formFileMultiple1" >
                ...
                <div style="margin-bottom:70px;margin-top:40px;">
                    <center>
                    <button style="background:#63C8FF;font-family: 'Raleway', sans-serif;" class="exp-btn btn--voi" type="submit" name="submit" >Submit</button>
                    </center>
                </div>                
            </form>
            </div>
