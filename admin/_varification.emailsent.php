...
<head>    
    ...
    <title>EMAIL | PCCOE BLOGSPOT</title>
...
$method = $_SERVER['REQUEST_METHOD'];
    ...
    if($result){        
        ...
        echo"Some Error Occured Field doesnt updated please <a href='https://pccoeblogspot.herokuapp.com/contactus.php'>contact here</a>";
    }
...
?>
    ...
    <center>   
        <div style="max-width:600px;padding:30px;" >            
            <h3 style="padding-top: 30px; padding-bottom: 30px;font-size:30px;font-family: 'Orbitron', sans-serif;">Welcome To PCCOE BLOGSPOT !</h3>
            <div style="padding-top: 10px;">
                <h4 style="text-align:start;">
                ...
                <h4>Best Of luck ! and Happy Coding !</h4>   
                <h4>or goto <a href="https://pccoeblogspot.herokuapp.com/index.php">Home</a></h4>          
            </div>
        </div>
    </center>        
    </div>
